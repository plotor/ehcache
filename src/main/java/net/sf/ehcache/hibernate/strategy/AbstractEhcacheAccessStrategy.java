...
abstract class AbstractEhcacheAccessStrategy<T extends EhcacheTransactionalDataRegion> {
     ...
     * @see org.hibernate.cache.access.CollectionRegionAccessStrategy#putFromLoad(Object, Object, long, Object)
     */
    public final boolean putFromLoad(Object key, Object value, long txTimestamp, Object version) throws CacheException {
        return this.putFromLoad(key, value, txTimestamp, version, settings.isMinimalPutsEnabled());
    }
     ...
     * @see org.hibernate.cache.access.CollectionRegionAccessStrategy#remove(Object)
     */
     ...
     * @see org.hibernate.cache.access.CollectionRegionAccessStrategy#evict(Object)
     */
