 ...
 *
 * @author Greg Luck
 * @version $Id: ManagementService.java 10789 2018-04-26 02:08:13Z adahanne $
 * @since 1.3
 */
public class ManagementService implements CacheManagerEventListener {
     ...
     * @param registerCacheConfigurations Whether to register the CacheConfiguration MBeans
     * @param registerCacheStatistics Whether to register the CacheStatistics MBeans
     * @see ManagementService#ManagementService(net.sf.ehcache.CacheManager, MBeanServer, boolean, boolean, boolean, boolean, boolean)
     * @since 2.2
     */
     ...
     * @param registerCacheConfigurations Whether to register the CacheConfiguration MBeans
     * @param registerCacheStatistics Whether to register the CacheStatistics MBeans
     * @see ManagementService#ManagementService(net.sf.ehcache.CacheManager, MBeanServer, boolean, boolean, boolean, boolean)
     */
    public static void registerMBeans(
            net.sf.ehcache.CacheManager cacheManager,
            MBeanServer mBeanServer,
    ...
    public void notifyCacheRemoved(String cacheName) {
        ...
        if (registerCaches) {
            this.unregisterMBean(Cache.createObjectName(backingCacheManager.toString(), cacheName));
        }
        if (registerCacheConfigurations) {
            this.unregisterMBean(CacheConfiguration.createObjectName(backingCacheManager.toString(), cacheName));
        }
        if (registerCacheStatistics) {
            this.unregisterMBean(CacheStatistics.createObjectName(backingCacheManager.toString(), cacheName));
        }
        if (registerCacheStores) {
            this.unregisterMBean(Store.createObjectName(backingCacheManager.toString(), cacheName));
        }
