...
public class SampledCacheManager extends BaseEmitterBean implements SampledCacheManagerMBean {
    ...
    public void clearAll() {
        ...
        this.sendNotification(CACHES_CLEARED);
    }
    ...
    public void setMaxBytesLocalDisk(long maxBytes) {
        ...
        this.sendNotification(CACHE_MANAGER_CHANGED, this.getCacheManagerAttributes(), this.getName());
    }
     ...
     * {@inheritDoc}
     *
     * @see SampledCacheManager#getName()
     */
    ...
    /**
     * @see SampledCacheManager#getClusterUUID()
     */
    ...
    public void setEnabled(boolean enabled) {
        ...
        this.sendNotification(CACHES_ENABLED, enabled);
    }
