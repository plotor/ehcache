...
public interface QueryManager {
    ...
    /**
     * Parses a {@link String String} statement expressing an Ehcache Search query and returns
     * a {@link Query Query} object for the cache specified in the statement.
     *
     * @param statement a String expressing an Ehcache Search query
     * @return a {@link Query Query}object tied to the cache specified in the statement
