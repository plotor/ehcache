...
public class Segment extends ReentrantReadWriteLock {
    ...
    private Element decode(Object object) {
        DiskSubstitute substitute = (DiskSubstitute) object;
    ...
    private void free(Object object, boolean faultFailure) {
        DiskSubstitute diskSubstitute = (DiskSubstitute) object;
    ...
    boolean replace(Object key, int hash, Element oldElement, Element newElement, ElementValueComparator comparator) {
        ...
        DiskSubstitute encoded = disk.create(newElement);
        ...
        try {
            ...
            if (e != null && comparator.equals(oldElement, decode(e.element))) {
                ...
                if (onDiskSubstitute instanceof DiskMarker) {
                    final long outgoingDiskSize = onDiskPoolAccessor.delete(((DiskMarker) onDiskSubstitute).getSize());
        ...
        try {
            ...
            if (e != null) {
                ...
                if (!onlyIfAbsent) {
                    ...
                    if (onDiskSubstitute instanceof DiskMarker) {
                        final long existingDiskSize = onDiskPoolAccessor.delete(((DiskMarker) onDiskSubstitute).getSize());
    ...
    /**
     * Remove the matching mapping.  Unlike the {@link Segment#remove(Object, int, Element, ElementValueComparator)} method
     ...
     */
    void addRandomSample(ElementSubstituteFilter filter, int sampleSize, Collection<DiskSubstitute> sampled, int seed) {
        if (count == 0) {
            return;
        }
        ...
        do {
            for (HashEntry e = tab[tableIndex]; e != null; e = e.next) {
                ...
                if (!e.faulted.get() && filter.allows(value)) {
                    sampled.add((DiskSubstitute) value);
                }
            }
