...
public final class DiskStore extends AbstractStore implements StripedReadWriteLockProvider, AuthoritativeTier {
     ...
     */
    public List<DiskSubstitute> getRandomSample(ElementSubstituteFilter factory, int sampleSize, Object keyHint) {
        ArrayList<DiskSubstitute> sampled = new ArrayList<DiskSubstitute>(sampleSize);
