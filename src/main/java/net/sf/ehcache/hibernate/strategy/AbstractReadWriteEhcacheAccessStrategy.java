...
abstract class AbstractReadWriteEhcacheAccessStrategy<T extends EhcacheTransactionalDataRegion> extends AbstractEhcacheAccessStrategy<T> {
     ...
     *
     * @see org.hibernate.cache.access.EntityRegionAccessStrategy#get(Object, long)
     * @see org.hibernate.cache.access.CollectionRegionAccessStrategy#get(Object, long)
     */
     ...
     * key.
     *
     * @see org.hibernate.cache.access.EntityRegionAccessStrategy#putFromLoad(Object, Object, long, Object, boolean)
     * @see org.hibernate.cache.access.CollectionRegionAccessStrategy#putFromLoad(Object, Object, long, Object, boolean)
     */
    @Override
     ...
     *
     * @see org.hibernate.cache.access.EntityRegionAccessStrategy#lockItem(Object, Object)
     * @see org.hibernate.cache.access.CollectionRegionAccessStrategy#lockItem(Object, Object)
     */
    public final SoftLock lockItem(Object key, Object version) throws CacheException {
        ...
        try {
            ...
            final Lock lock = (item == null) ? new Lock(timeout, uuid, this.nextLockId(), version) : item.lock(timeout, uuid, this.nextLockId());
            this.putLock(key, lock);
            return lock;
        } finally {
            region.writeUnlock(key);
        }
     ...
     *
     * @see org.hibernate.cache.access.EntityRegionAccessStrategy#unlockItem(Object, org.hibernate.cache.access.SoftLock)
     * @see org.hibernate.cache.access.CollectionRegionAccessStrategy#unlockItem(Object, org.hibernate.cache.access.SoftLock)
     */
