...
public final class TxCopyingCacheStore<T extends Store> extends AbstractCopyingCacheStore<T> {
    ...
    /**
     * Wraps the given {@link ElementValueComparator} if the configuration requires copy on read
     *
    ...
    /**
     * An {@link ElementValueComparator} which handles copy on read and {@link SoftLockID}
     */
