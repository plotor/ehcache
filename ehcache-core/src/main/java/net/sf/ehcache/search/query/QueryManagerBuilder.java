...
/**
 * A {@link QueryManager Query Manager} builder providing methods to add caches which
 * can be queried.
...
public final class QueryManagerBuilder {
     ...
     *
     * @param implementationClass a concrete implementation of the {@link QueryManager Query Manager} interface
     */
    ...
    /**
     * Creates a new {@link QueryManager Query Manager} builder.
     *
    ...
    /**
     * Adds a {@link Ehcache Cache} to the internal state and allows it to be used as a target in a
     * BMSQL statement's FROM clause.
     *
     * @param cache a {@link Ehcache cache} instance to be added
     * @return this for the builder pattern
     */
    ...
    /**
     * Adds all {@link Ehcache Caches} present in a {@link CacheManager Cache Manager} to
     * the internal state of the query manager.
     * The added caches can be used in a BMSQL statement's FROM clause.
     *
     * @param cacheManager a {@link CacheManager Cache Manager} whose
     *                     {@link Ehcache caches} need to be added
     * @return this for the builder pattern
     */
    ...
    /**
     * Returns a new {@link QueryManager Query Manager} using the options supplied during the building
     * process.
     *
     * @return the fully constructed {@link QueryManager Query Manager}
     */
