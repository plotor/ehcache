...
public class ManagementService implements CacheManagerEventListener {
     ...
     * @throws CacheException if something goes wrong with init()
     * @since 2.2
     */
     ...
     * from {@link Status#STATUS_UNINITIALISED} to
     * {@link Status#STATUS_ALIVE}. Care should be taken on processing that
