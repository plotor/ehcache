...
public class EhcacheHibernate extends BaseEmitterBean implements EhcacheHibernateMBean {
    ...
    public void setStatisticsEnabled(boolean flag) {
        ...
        this.sendNotification(HibernateStats.CACHE_STATISTICS_ENABLED, flag);
    }
    ...
    public void flushRegionCache(String region) {
        ...
        this.sendNotification(HibernateStats.CACHE_REGION_FLUSHED, region);
    }
    ...
    public void flushRegionCaches() {
        ...
        this.sendNotification(HibernateStats.CACHE_FLUSHED);
    }
    ...
    public void setRegionCachesEnabled(boolean enabled) {
        ...
        this.sendNotification(HibernateStats.CACHE_ENABLED, enabled);
    }
    ...
    public void setRegionCacheEnabled(String region, boolean enabled) {
        ...
        this.sendNotification(HibernateStats.CACHE_REGION_CHANGED, this.getRegionCacheAttributes(region), region);
    }
