 ...
 * @author Greg Luck
 * @author Geert Bevin
 * @version $Id: RegisteredEventListeners.java 10789 2018-04-26 02:08:13Z adahanne $
 */
        ...
        if (this.hasCacheEventListeners()) {
            for (ListenerWrapper listenerWrapper : cacheEventListeners) {
                if (listenerWrapper.getScope().shouldDeliver(remoteEvent)
                    ...
                    listener.notifyElementRemoved(cache, this.resolveElement(listener, element, callback));
                }
            }
        }
    }
        ...
        if (this.hasCacheEventListeners()) {
            for (ListenerWrapper listenerWrapper : cacheEventListeners) {
                if (listenerWrapper.getScope().shouldDeliver(remoteEvent)
                    ...
                    listener.notifyElementPut(cache, this.resolveElement(listener, element, callback));
                }
            }
        }
    }
        ...
        if (this.hasCacheEventListeners()) {
            for (ListenerWrapper listenerWrapper : cacheEventListeners) {
                if (listenerWrapper.getScope().shouldDeliver(remoteEvent)
                    ...
                    listener.notifyElementUpdated(cache, this.resolveElement(listener, element, callback));
                }
            }
        }
    }
        ...
        if (this.hasCacheEventListeners()) {
            for (ListenerWrapper listenerWrapper : cacheEventListeners) {
                if (listenerWrapper.getScope().shouldDeliver(remoteEvent)
                    ...
                    listener.notifyElementExpired(cache, this.resolveElement(listener, element, callback));
                }
            }
        }
    }
        ...
        if (this.hasCacheEventListeners()) {
            for (ListenerWrapper listenerWrapper : cacheEventListeners) {
                if (listenerWrapper.getScope().shouldDeliver(remoteEvent)
                    ...
                    listener.notifyElementEvicted(cache, this.resolveElement(listener, element, callback));
                }
            }
        }
    }
