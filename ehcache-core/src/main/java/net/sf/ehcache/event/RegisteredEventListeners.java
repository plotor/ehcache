...
public class RegisteredEventListeners {
    ...
    private final OperationObserver<ExpiredOutcome> expiryObserver = operation(ExpiredOutcome.class).named("expiry")
   ...
   /**
     ...
     * @param element
     * @param remoteEvent whether the event came from a remote cache peer
     * @see CacheEventListener#notifyElementPut(Ehcache, Element)
     */
