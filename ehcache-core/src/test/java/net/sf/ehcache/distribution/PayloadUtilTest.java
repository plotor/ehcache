...
public class PayloadUtilTest extends AbstractRMITest {
    ...
    private static class PayloadUtilTestCachePeer implements CachePeer {
         ...
         * {@inheritDoc}
         *
         * @see CachePeer#getElements(List)
         */
         ...
         * {@inheritDoc}
         *
         * @see CachePeer#getQuiet(Serializable)
         */
         ...
         * {@inheritDoc}
         *
         * @see CachePeer#remove(Serializable)
         */
