...
public class EhcacheDecoratorAdapter implements InternalEhcache {
     ...
     * {@inheritDoc}
     *
     * @see net.sf.ehcache.Ehcache#addPropertyChangeListener(PropertyChangeListener)
     */
     ...
     * {@inheritDoc}
     *
     * @see net.sf.ehcache.Ehcache#removePropertyChangeListener(PropertyChangeListener)
     */
