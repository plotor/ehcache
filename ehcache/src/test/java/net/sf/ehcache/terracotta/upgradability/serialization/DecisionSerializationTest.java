...
import static net.sf.ehcache.transaction.id.Decision.COMMIT;
import static net.sf.ehcache.transaction.id.Decision.IN_DOUBT;
import static net.sf.ehcache.transaction.id.Decision.ROLLBACK;
